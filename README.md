...
<img width="70%" src="https://github.com/pueser/food-killer/assets/117990884/8be4484c-71d6-4224-9326-8eb7aa0cb742"/> 
...
<img width="70%" src="https://github.com/pueser/food-killer/assets/117990884/ad3d3099-e44e-4d18-ae67-5714d9d418af"/> 
...
## [검색(필터, 초성)] ##
-초성검색시 검색한 각 초성의 유니코드의 값에 따라  각각의 초성으로 변할 수 있도록 oracleDB에 해당 기능이 있는 함수를 만들어 사용했습니다. 사용자는 checkbox를 통해 원하는 카테고리를 선택하고, SQL 문법에서는 JSTL을 활용하여 선택된 카테고리만을 추출하도록 설정했습니다. 이렇게 함으로써 사용자가 선택한 카테고리와 검색 조건에 맞는 음식점 정보를 효율적으로 추출하여 제공했습니다.
